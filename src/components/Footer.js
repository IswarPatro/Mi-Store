...
const Footer = ({footer}) => {
  return (
    ...
    <div className="PreFooter">
        <div>
            <div>
                ...
                <br />10-day easy replacement policy on mi.com</p>
            </div>
            <div>
                {shieldIcon}
                <p><b>100% secure payments</b>
                <br />We supports Cards, Wallets, EMI and COD</p>
            </div>
            <div>
                {mapIcon}
                <p><b>Vest service network</b>
                <br />1000 Mi service-centers across 600 cities</p>
            </div>
        </div>
    </div>
    ...
    <div className="footerBorder">
        <div>Copyright © 2010 - 2011 Xiaomi.All Rights Reserved</div>
    </div>
